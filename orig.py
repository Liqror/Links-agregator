...
"color: rgb(255, 255, 255);")
        self.plus.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("Pic/другой плюс.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"border-width: 0px;")
        self.label.setText("")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("Pic/стрелка назад для темы2.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon2.addPixmap(QtGui.QPixmap("Pic/стрелка назад для темы2.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        icon2.addPixmap(QtGui.QPixmap("Pic/стрелка назад для темы2.jpg"), QtGui.QIcon.Active, QtGui.QIcon.Off)
        icon2.addPixmap(QtGui.QPixmap("Pic/стрелка назад для темы2.jpg"), QtGui.QIcon.Active, QtGui.QIcon.On)
        icon2.addPixmap(QtGui.QPixmap("Pic/стрелка назад для темы2.jpg"), QtGui.QIcon.Selected, QtGui.QIcon.Off)
        icon2.addPixmap(QtGui.QPixmap("Pic/стрелка назад для темы2.jpg"), QtGui.QIcon.Selected, QtGui.QIcon.On)
...
"border-width: 0px;")
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("Pic/крестик.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
